...
| V5 | LLM probe variance | **open** | Needs OpenAI/Anthropic/Gemini keys + ~$5 budget: same 10-prompt set × 10 reruns × 3 models × 5 known apps; report mention-rate variance and derive minimum prompt count for stable share-of-voice. Runs before Wave 2.1 pricing. |
